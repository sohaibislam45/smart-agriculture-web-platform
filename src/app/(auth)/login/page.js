    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="flex justify-end text-xs">
          <Link
            href={email ? `/forgot-password?email=${encodeURIComponent(email)}` : "#"}
            className={`${email ? "text-gray-500 hover:underline" : "text-gray-300 cursor-not-allowed"}`}
      ...
      <p className="text-xs text-gray-500 text-center mt-4">
        ...
        <Link href="/register" className="text-black hover:underline">Sign up</Link>
      </p>
...
export default function LoginPage() {
  return (
    ...
    >
      ...
      >
        <Image src={logoImg} alt="SmartAgri Logo" width={30} height={30} className="rounded-md" />
